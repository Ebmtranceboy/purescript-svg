...
(function($PS) {
  ...
  var renderRightAngle = new Render(function (v) {
      return function (v1) {
          var w = SVG_Geometry.scale(v1.radius / SVG_Geometry.length(SVG_Geometry.measurableVector)(v1.extremity))(v1.origin);
          ...
          return $foreign.svgpath(v.svg)(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(o)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(o)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(m)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(m)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(n)) + (" " + Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(n)))))))))))))));
      };
  });
  var renderPoint = new Render(function (v) {
      return function (v1) {
          return function __do() {
              ...
              $foreign.svgline(v.svg)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v1) - 5.0)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v1) + 5.0)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v1) + 5.0)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v1) - 5.0)(v.stroke)(v.strokeWidth)();
              return $foreign.svgtext(v.svg)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v1) + 10.0)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v1) - 10.0)(v.fill)(v.fontStyle)(v1.name)();
          };
      };
  });
  ...
  var renderArc = new Render(function (v) {
      return function (v1) {
          ...
          return function __do() {
              $foreign.svgpath(v.svg)(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(pO)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(pO)) + (" " + ("a " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + (Data_Show.show(Data_Show.showNumber)(v1.radius) + (" " + ("0 0 " + ((function () {
                  if (v1.swapped) {
                      return "0";
                  };
                  return "1";
              })() + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(pE) - SVG_Geometry.abs(SVG_Geometry.basedPoint)(pO)) + (" " + Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(pE) - SVG_Geometry.ord(SVG_Geometry.basedPoint)(pO)))))))))))))))))();
              var d = 0.8 - 4.0e-3 * v1.radius;
              var p = SVG_Geometry.plus(SVG_Geometry.summableVectorVector)(SVG_Geometry.plus(SVG_Geometry.summableVectorVector)(SVG_Geometry.scale((function () {
                  if (v1.flipped) {
                      return d;
                  };
                  return -d;
              })())(v2))(v1.origin))(SVG_Geometry.scale(-1.0)(SVG_Geometry.projection(v1.extremity)(v1.origin)));
              var n = SVG_Geometry.plus(SVG_Geometry.summublePointVector)(pE)(SVG_Geometry.scale((function () {
                  if (v1.flipped) {
                      return -1.0;
                  };
                  return 1.0;
              ...
              Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (str) {
                  return $foreign.svgpath(v.svg)(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v3.at2)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v3.at2)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(pE)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(pE)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v3.at1)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v3.at1)) + " Z"))))))))))))));
              })(v1.asOriented)();
              ...
              return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (str) {
                  return $foreign.svgtext(v.svg)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(i))(SVG_Geometry.ord(SVG_Geometry.basedPoint)(i))(v.fill)(v.fontStyle)(str);
              })(v1.asOriented)();
          };
      };
  });
  var renderSegment = new Render(function (v) {
      return function (v1) {
          return function __do() {
              ...
              Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (str) {
                  var v2 = arrowTip(v1);
                  return $foreign.svgpath(v.svg)(v.stroke)(v.strokeWidth)(v.fill)("M " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v2.at1)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v2.at1)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v1.extremity)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v1.extremity)) + (" " + ("L " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(v2.at2)) + (" " + (Data_Show.show(Data_Show.showNumber)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(v2.at2)) + (" " + "Z")))))))))))))));
              })(v1.asOriented)();
              var m = SVG_Geometry.middle("")(v1);
              return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (str) {
                  return function __do() {
                      $foreign.svgtext(v.svg)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(m) + 10.0)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(m) - 10.0)(v.fill)(v.fontStyle)(str)();
                      return $foreign.svgtext(v.svg)(SVG_Geometry.abs(SVG_Geometry.basedPoint)(m) + 10.0)(SVG_Geometry.ord(SVG_Geometry.basedPoint)(m) - 23.0)(v.fill)(v.fontStyle)((function () {
                          var $82 = str === "";
                          if ($82) {
                              return "";
                          };
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var pA = SVG_Geometry.point("A")(10.0)(10.0);
      var pB = SVG_Geometry.point("B")(50.0)(50.0);
      var h1 = SVG_Geometry.halfline(pA)(SVG_Geometry.vector(pA)(pB));
      SVG_Render["render'"](SVG_Render.renderHalfLine)(context)(h1)();
      SVG_Render["render'"](SVG_Render.renderSequence(SVG_Render.renderPoint))(context)([ pA, pB ])();
      var pC = SVG_Geometry.point("C")(20.0)(40.0);
      SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(pB)(pC)(Data_Maybe.Nothing.value))();
      var c = SVG_Geometry.circle(pB)(SVG_Geometry.length(SVG_Geometry.measurableVector)(SVG_Geometry.vector(pC)(pB)));
      ...
      var pD = SVG_Geometry.plus(SVG_Geometry.summublePointVector)(pB)(SVG_Geometry.normalTo(SVG_Geometry.vector(pA)(pB)));
      SVG_Render["render'"](SVG_Render.renderPoint)(context)(pD)();
      SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(pB)(pD)(Data_Maybe.Nothing.value))();
      SVG_Render["render'"](SVG_Render.renderRightAngle)({
          ...
          strokeWidth: context.strokeWidth,
          fontStyle: context.fontStyle
      })(SVG_Geometry.rightangle(SVG_Geometry.vector(pB)(pA))(pB)(SVG_Geometry.vector(pB)(pD))(10.0))();
      return SVG_Render["render'"](SVG_Render.renderArc)(context)(SVG_Geometry.arc(SVG_Geometry.vector(pB)(pA))(pB)(SVG_Geometry.vector(pB)(pC))(25.0)(true)(true)(Data_Maybe.Nothing.value))();
  };
  exports["main"] = main;
